      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              ...
              <div class="home-btn text-center text-lg-left text-md-left my-4">
                <a class="py-3 px-4" href="<?php the_permalink(); ?>"><?php echo esc_html('READ MORE','building-construction-lite'); ?></a>
              </div>
            </div>
          </div>
          <?php $i++; endwhile;
        ...
        <div class="no-postfound"></div>
          ...
          <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon px-3 py-2" aria-hidden="true"><?php esc_html_e('PREV','building-construction-lite'); ?></span>
          </a>
          <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
            <span class="carousel-control-next-icon px-3 py-2" aria-hidden="true"><?php esc_html_e('NEXT','building-construction-lite'); ?></span>
          </a>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <?php
            ...
            $page_query = new WP_Query(array( 'category_name' => esc_html($project_category ,'building-construction-lite')));?>
                      ...
                      <div class="col-lg-6 col-md-6">
                        <div class="my-md-5 my-lg-0">
                          ...
                          <div class="box-button">
                            <a class="py-2 px-3" href="<?php the_permalink(); ?>"><?php esc_html_e('READ MORE','building-construction-lite');?></a>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <?php if( get_theme_mod('building_construction_lite_about_us_title') != '' || get_theme_mod('building_construction_lite_about_us_settigs') != ''){ ?>
    <section id="about-us" class="py-5">
      <div class="container">
        <div class="row">
          <?php
            $mod =  get_theme_mod( 'building_construction_lite_about_us_settigs');
            if ( 'page-none-selected' != $mod ) {
              $construction_firm_about_page[] = $mod;
            }
          ...
          <?php  while ( $query->have_posts() ) : $query->the_post(); ?>
            ...
            <div class="col-lg-7 col-md-7 align-self-center">
              <h3 class="mb-3"><?php echo esc_html( get_theme_mod( 'building_construction_lite_about_us_title','') ); ?></h3>
